    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-10">
      ...
      <section className="card p-8">
        ...
        <p className="text-sm text-gray-400">
          ...
          הציבורי של משתמשים אחרים, וגם אצלכם בעמוד הפרופיל תוכלו לראות לאיזה שלב הגעתם. חשבונות
          PRO, מנהל בפועל, וצוות הפיקוח מקבלים את היכולת הזו פתוחה תמיד, ללא תלות בכמות
          האפליקציות.
        </p>
      ...
      <section className="card p-8">
        ...
        <p className="text-sm text-gray-400">
          ...
          משלכם למאגר, או בהגעה ל-25 מוניטין (מכל מקור - גם בלי אף העלאה).
        </p>
        <p className="mt-3 text-sm text-gray-400">
