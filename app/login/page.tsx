...
function LoginForm() {
  ...
  // התחברות/הרשמה עם Google - אותה פעולה משמשת גם למשתמש חדש (יוצרת חשבון אוטומטית)
  // וגם לקיים (מתחברת). flow=oauth מסמן ל-app/auth/callback/route.ts לנווט ישר פנימה
  // לפי תפקיד, בלי להראות שוב את מסך ההתחברות.
  async function handleGoogleSignIn() {
    ...
    // בהצלחה - הדפדפן מנווט לגוגל, אין צורך לעשות כאן עוד כלום.
  }
