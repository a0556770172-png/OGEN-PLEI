// הגדרות קבועות של הפרויקט - בטוחות לחשיפה בצד לקוח (מפתח "publishable" בלבד, לא סודי).
// כתובת האתר עצמה ניתנת לעריכה ע"י המשתמש בעמוד ההגדרות (options.html) - כי היא עשויה
