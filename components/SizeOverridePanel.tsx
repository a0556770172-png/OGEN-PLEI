    ...
    <div className="flex flex-col gap-4">
      <div className="card p-4">
        <p className="text-sm text-gray-400">
          ...
          (מעבר למכסה הרגילה שלו - 30MB בחשבון רגיל, 100MB בחשבון PRO). ברגע שהמשתמש בפועל
          מעלה קובץ שחורג מהמכסה הרגילה שלו, ההרשאה מתבטלת אוטומטית ולא ניתן לנצל אותה שוב
          בלי אישור חדש. אם הוא מעלה בינתיים קובץ בתוך המכסה הרגילה, ההרשאה נשארת שמורה.
        </p>
      </div>
